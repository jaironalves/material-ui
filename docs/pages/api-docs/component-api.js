...
function ComponentApi(props) {
  ...
  return (
    <React.Fragment>
      ...
      <AppTableOfContents items={toCItems} />
...
//   const componentId = uppercaseFirst(kebapToCamelCase(params.component));

//   const requireApi = require.context('docs/api', false, /\.json$/);
//   const api = requireApi(`./${componentId}.json`);
